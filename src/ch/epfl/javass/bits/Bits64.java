...
public final class Bits64 {
     ...
     * 
     * @param start
     *            le départ (inclus) (doit être positif et plus petit que 65)
     * @param size
     *            la taille (doit être positif et start+size<=64)
     ...
     * @param start
     *            le début de la plage (inclus) (doit être positif et plus petit
     *            que 65)
     * @param size
     *            la taille de la plage (doit être positif et start+size<=64)
     ...
     * 
     * @param v1
     *            le nombre (long) qui occupe les s1 premier bits de poids
     *            faible
     * @param s1

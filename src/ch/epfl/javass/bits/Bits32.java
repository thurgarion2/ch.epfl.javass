...
/**
 * useful methods to work with binary representation of Integer
 * 
...
public final class Bits32 {
     ...
     * 
     * @throws IllegalArgumentException
     *             si s1 ou s2 ou s3 negatif ou s1+s2+s3>32 ou ne respecte pas les
     *             conditions de tailles de v1 et v2 et v3 cf s1,s2,s3
     */

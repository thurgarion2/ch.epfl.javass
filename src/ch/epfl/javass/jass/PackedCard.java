...
public final class PackedCard {
    ...
    //tableau des points (sonstante) selon si la cartes est un atout ou non 
     ...
     * 
     * @return true, si le format entier de la carte est valide 
    ...
    /**
     * empacte une carte dans le format d'entier en partant du rang et de la couleur de la carte
     * 
    ...
    // extrait, de la forme empactée de la carte, l'entier représentant la couleur de la carte
    ...
    // extrait, de la forme empactée de la carte, l'entier représentant le rang de la carte
    ...
    //même chose que rankIndex(), en consideérant l'odre des rangs de la couleur d'atout
    ...
    /**
     * regarde si la première carte est meilleure que la seconde (format empaueté pour les deux cartes)
     * 
     ...
     * 
     * @return vrai si pkCradL est meilleure que pkCardR,
     * 		   faux sinon (y compris si les cartes ne sont pas "comaprables directement")
     */

...
public final class CardSet {
     ...
     * 
     * @param packed
     *            l'ensemble sous sa version empaquetée
     * 
     * @return l'ensemble de cartes généré à partir de la liste de cartes
     * 
     ...
     * 
     * @return vrai si l'ensemble de cartes est vide faux si l'ensemble de
     *         cartes est plein
     */
     ...
     *            la carte a enlever
     * 
     * @return un nouvel ensemble basésur l'ensemble de cartes donné auquel la
     *         carte donnéee a été retirée
     */
    ...
    /**
     * définit l'ensemble de cartes contenant toutes les cartes de deux
     * ensembles
     * 
     * @param that
     *            le deuxième ensemble de cartes
     * 
     ...
     *            le deuxième ensemble de cartes
     * 
     * @return un nouvel ensemble de cartes correspondant à l'intersection des
     *         deux ensembles
     */
    ...
    /**
     * suprime les éléments de l'ensemble de cartes qui appartiennent à
     * l'enemble passé en argument
     * 
     * @param that
     *            le deuxième ensemble de cartes
     * 
     * @return un nouvel ensemble de cartes qui est le premier sans les éléments
     *         de celui passé en argument
     */
     ...
     *            la couleur
     * 
     * @return le sous-ensemble de l'ensemble de cartes donné constitué
     *         uniquement des cartes de la couleur donnée
     */

...
public final class Score {
	...
	//premete de crér un Score en "interne"
	...
	/**
	 * crée un score à partir d'une version empaquetée
	 * 
	 ...
	 * 
	 * @param t l'identifiant de l'équipe
	 * 
	...
	/**
	 * retourne le nombre de points gagné au totale durant la partie par l'équipe
	 ...
	 * 
	 * @throws IllegalArgumentException si le nombre de point du pli est invalide,
	 *                                  c-t-d. qu'il est strictement plus petit que
	 *                                  0
	 */
	...
	/**
	 * met à jour les points de la partie avec les points du dernier tour et remets
	 * à 0 le nombre de plis et les points du tour courant de chaque équipe
	 * 
